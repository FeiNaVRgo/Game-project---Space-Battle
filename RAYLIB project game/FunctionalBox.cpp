...
FunctionalBox::FunctionalBox(const raylib::Vector2& pos, const raylib::Color& colRect, const raylib::Text& text) : text(text), colRect(colRect) {
    rect.SetPosition(pos);
    raylib::Vector2 measurment = text.MeasureEx();
    rect.height = measurment.y;
    rect.width = measurment.x;
}

FunctionalBox::FunctionalBox(const raylib::Text& text, const raylib::Rectangle& rect, const raylib::Color& colRect) : rect(rect), colRect(colRect), text(text) {}

bool FunctionalBox::update() {
...
void  FunctionalBox::changeTextOnInput(uint16_t& _t) {
...
void FunctionalBox::DrawTextBoxed(bool wordWrap) {
	DrawTextBoxedSelectable(text.font, text.text.c_str(), rect, text.fontSize, text.spacing, wordWrap, text.color, 0, 0, WHITE, WHITE);
}

void FunctionalBox::DrawTextBoxedSelectable(Font font, const char* text, Rectangle rec, float fontSize, float spacing, bool wordWrap, Color tint, int selectStart, int selectLength, Color selectTint, Color selectBackTint) {
...
void FunctionalBox::DrawTextBoxed(Font font, std::string text, Rectangle rec, float fontSize, float spacing, bool wordWrap, Color tint) {
    DrawTextBoxedSelectable(font, text.c_str(), rec, fontSize, spacing, wordWrap, tint, 0, 0, WHITE, WHITE);
}